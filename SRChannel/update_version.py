...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright SheepRaider, " + str(today.year)
  ...
  plistpath = scriptpath + "/resources/SRChannel-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRChannel-RTAS-Info.plist"
...
#   plistpath = scriptpath + "/resources/SRChannel-IOSAPP-Info.plist"
